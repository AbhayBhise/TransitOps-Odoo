...
export default function Navbar() {
  ...
  return (
    <header className="h-16 px-6 border-b border-slate-800 bg-slate-950 flex items-center justify-between sticky top-0 z-30">
      {/* Search Bar / Context Info */}
      <div className="flex items-center gap-4">
        <span className="text-xs font-bold uppercase tracking-widest text-slate-500 bg-slate-900 border border-slate-800 px-2.5 py-1 rounded-md">
          Hub: Fleet-Alpha
        </span>
      </div>
      ...
      <div className="flex items-center gap-4">
        {/* Globe icon */}
        <button className="p-2 text-slate-400 hover:text-slate-200 hover:bg-slate-900/60 rounded-xl transition-colors">
          <Globe size={18} />
        </button>
        ...
        <div className="relative">
          <button
            ...
            className="p-2 text-slate-400 hover:text-slate-200 hover:bg-slate-900/60 rounded-xl transition-colors relative"
          >
            <Bell size={18} />
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-3 w-80 bg-slate-900 border border-slate-800 rounded-xl shadow-2xl glass-panel overflow-hidden py-1">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2.5 p-1 px-2.5 rounded-xl border border-slate-800/80 hover:bg-slate-900/60 transition-colors"
          >
          ...
          {showProfile && (
            <div className="absolute right-0 mt-3 w-48 bg-slate-900 border border-slate-800 rounded-xl shadow-2xl glass-panel overflow-hidden py-1.5">
              <div className="px-4 py-2 border-b border-slate-800">
                <p className="text-xs font-bold text-slate-200">Alex Driver</p>
                <p className="text-[10px] text-slate-500">manager@transitops.com</p>
              </div>
              <button
                className="w-full text-left px-4 py-2 text-xs text-slate-300 hover:bg-slate-850 hover:text-slate-100 transition-colors"
              >
                My Profile
              </button>
              <button
